<html><head>
  ...
  <body>
    <div class="podkat">
    <form  action="wysyl.php" method="post" enctype='multipart/form-data'>
    <label><br>Wybierz do jakiej kategorii chcesz dodać aukcje:<br><br> <select name='kategoriaaukcja'>
      <?php
